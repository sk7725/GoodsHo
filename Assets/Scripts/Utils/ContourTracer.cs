...
public class ContourTracer {
    ...
    public void Trace(Texture2D texture, Vector2 pivot, float pixelsPerUnit, uint gapLength, float product, float alphaCutoff = 0.25f) {
        ...
        bool IsBorder(int _x, int _y) {
            ...
            return pixels[pixelIndex].a > alphaCutoff; //.r != 0f;
        }
